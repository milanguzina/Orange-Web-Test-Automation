...
WebUI.click(findTestObject('Admin Page/Qualifications/Memberships/button_Delete'))

WebUI.click(findTestObject('Admin Page/Qualifications/Languages/button_Yes, Delete'))
