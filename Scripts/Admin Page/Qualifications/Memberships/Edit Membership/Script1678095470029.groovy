...
WebUI.click(findTestObject('Admin Page/Qualifications/Memberships/li_Memberships'))

WebUI.click(findTestObject('Admin Page/Qualifications/Memberships/button_Edit'))

WebUI.sendKeys(findTestObject('Admin Page/Qualifications/Memberships/textbox_Username'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Admin Page/Qualifications/Skills/textbox_Username_selected'), 'Platinum Membership-Automation')
