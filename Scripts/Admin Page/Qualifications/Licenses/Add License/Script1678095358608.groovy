...
WebUI.sendKeys(findTestObject('Admin Page/Qualifications/Skills/textbox_Username'), 'Practicioner Beginner-Automation')

WebUI.takeScreenshotAsCheckpoint('License Info')
