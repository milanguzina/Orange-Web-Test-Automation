...
WebUI.click(findTestObject('Admin Page/Qualifications/Licenses/li_Licenses'))

WebUI.click(findTestObject('Admin Page/Qualifications/Licenses/button_Edit'))

WebUI.sendKeys(findTestObject('Admin Page/Qualifications/Skills/textbox_Username'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Admin Page/Qualifications/Skills/textbox_Username_selected'), 'Practicioner Advanced-Automation')
