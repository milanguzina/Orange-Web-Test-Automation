...
WebUI.click(findTestObject('Admin Page/Qualifications/Languages/li_Languages'))

WebUI.click(findTestObject('Admin Page/Qualifications/Languages/button_Add'))

WebUI.sendKeys(findTestObject('Admin Page/Qualifications/Skills/textbox_Username'), 'Afgan-Automation')

WebUI.takeScreenshotAsCheckpoint('Language info')
...
WebUI.takeScreenshotAsCheckpoint('Language Added')
